...
\begin{tabular}{ |M{2.5cm}|M{2cm}|M{2cm}|M{2cm}|M{2cm}|M{2cm}|M{2cm}| }
    ...
    \hline
    IMDB-BINARY & 1000 & 1 & 2 & 19.8 & 193.1 & 8.89 \\
    \hline
...
\scriptsize
\renewcommand{\arraystretch}{1.5}
\begin{tabular}{ |M{3cm}|M{0.5cm}|M{2.5cm}|M{4.5cm}|M{1cm}|M{1.5cm}|M{1.5cm}| }
    \hline
    \multicolumn{7}{|c|}{Results} \\
    \hline
    model name & type & dataset & concepts & epoch & test accuracy & test ROC AUC\\
    \hline
    GIN & 0 & IMDB-BINARY & - & 150 & 0.725 & 0.799 \\
    \hline
    GIN\_SGIN\_noSINIT & 1 & IMDB-BINARY & cyclebasis & 150 & 0.705 & 0.773\\
    \hline
    GIN\_SGIN\_noSINIT & 1 & IMDB-BINARY & maxclique & 150 & 0.690 & 0.791 \\
    \hline
    HGIN\_m\_simple & 3 & IMDB-BINARY & cyclebasis & 150 & 0.755 & 0.873 \\
    \hline
    HGIN\_m\_simple & 3 & IMDB-BINARY & maxclique & 150 & 0.730 & 0.849 \\
    \hline
    HGIN\_m\_simple & 3 & IMDB-BINARY & cycb\_maxcliq\_star2 \_minl\_maxl & 150 & 0.750 & 0.860 \\
    \hline
\end{tabular}
}\\
\noindent
...
\begin{tabular}{ |M{3cm}|M{0.5cm}|M{2.5cm}|M{4.5cm}|M{1cm}|M{1.5cm}|M{1.5cm}| }
    \hline
    GIN & 0 & PROTEINS & - & 150 & 0.744 & 0.811\\
    \hline
    GIN\_SGIN\_noSINIT & 1 & PROTEINS & cyclebasis & 150 & 0.789 & 0.864\\
    \hline
    GIN\_SGIN\_noSINIT & 1 & PROTEINS & maxclique & 150 & 0.785 & 0.857\\
    \hline
    HGIN\_m\_simple & 3 & PROTEINS & cyclebasis & 150 & 0.722 & 0.831\\
    \hline
    HGIN\_m\_simple & 3 & PROTEINS & maxclique & 150 & 0.802 & 0.885\\
    \hline
    HGIN\_m\_simple & 3 & PROTEINS & cycb\_maxcliq\_star2 \_minl\_maxl & 150 & 0.686 & 0.851\\
    \hline
\end{tabular}
}\\\\
...
In both dataset with the right concepts the supernode models perform better than the base model. Further investigation can be done by tuning more the models.
