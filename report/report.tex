...
\noindent
\textbf{Dataset}\\
Both the datasets didn't contains any splitting mask for training, validation and test. We decided to split them 0.6, 0.2 and 0.2 respectively after applying a random shuffle. To make the experiments reproducible we set every random seed to a fix number.\\
