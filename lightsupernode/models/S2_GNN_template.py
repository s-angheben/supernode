...
class S2_GNN(L.LightningModule):
    def __init__(self, supconv, gnn, classifer, readout, out_channels):
        super(S2_GNN, self).__init__()

        self.gnn = gnn
        self.supconv = SupConv(supconv)
    ...
    def forward(self, x, edge_index, S, edge_S, batch):
        ...
        x = self.supconv(x, edge_index, S, edge_S)
