...
from .S2_GNN_template import S2_GNN

def get_GCNS2_model(in_channels: int, out_channels: int,
        ...
        model = S2_GNN(supconv, gnn, classifier, readout, out_channels)
...
def get_GINS2_model(in_channels: int, out_channels: int,
                    hidden_channels: int = 64, num_layers: int = 3,
                    dropout: float = 0.5):
        supconv = SimpleConv("add")
