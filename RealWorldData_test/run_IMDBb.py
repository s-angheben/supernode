...
dm = TUDIMDBbDataModule("./dataset/IMDb_normal", batch_size=BATCH_SIZE,
...
logger = TensorBoardLogger("tb_logs/" + "IMDb_normal", model_log["model"])
logger.log_hyperparams(dict({"device": device,
                        "dataset": "IMDb", "epochs": MAX_EPOCH}, **model_log))
