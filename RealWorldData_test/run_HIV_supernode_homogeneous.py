...
transformation = T.Compose([squeeze_y, AddSupernodes(concept_list)])
...
logger = TensorBoardLogger("tb_logs/" + "HIV_hom", model_log["model"], concept_list_name)
